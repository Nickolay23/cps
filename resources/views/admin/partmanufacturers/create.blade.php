...
@section('content')
    ...
    <form action="{{route('admin.partmanufacturers.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                ...
                @enderror
                <input type="text" name="partmanufacturer" class="form-control" id="partmanufacturer" value="{{old('partmanufacturer')}}">
            </div>
        </div>
        <div class="row mb-3">
